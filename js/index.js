...
const wrapper=document.querySelector(".wrap7 .wrapper");
const carousels=document.querySelector(".wrap7 .carousel");
const arrowBtns=document.querySelectorAll(".wrap7 .wrapper i");
const firstCardWidth=carousels.querySelector(".wrap7 .cards").offsetWidth;
